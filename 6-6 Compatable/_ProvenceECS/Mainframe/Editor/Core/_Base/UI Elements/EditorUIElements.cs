...
namespace ProvenceECS.Mainframe{
    ...
    public partial class ListItem : VisualElement{
        ...
        public Vector3Field AddVector3Field(UnityEngine.Vector3 value = new UnityEngine.Vector3(), bool alternate = false, bool secondAlternate = false, bool thirdAlternate = false){
        ...
        public Vector4Field AddVector4Field(UnityEngine.Vector4 value = new UnityEngine.Vector4(), bool alternate = false, bool secondAlternate = false, bool thirdAlternate = false){
        ...
        public Vector2Field AddVector2Field(UnityEngine.Vector2 value = new UnityEngine.Vector2(), bool alternate = false, bool secondAlternate = false, bool thirdAlternate = false){
    ...
    [UxmlElement]
    public partial class ListItemText : TextElement{
    ...
    [UxmlElement]
    public partial class ListItemIntInput : IntegerField{
        public EventManager<MainframeUIArgs> eventManager;
    ...
    [UxmlElement]
    public partial class ListItemTextInput : TextField{
    ...
    [UxmlElement]
    public partial class ListItemImage : VisualElement{
        ...
        public string src { 
            ...
            {
                srcString = value;
                SetImage(AssetDatabase.LoadAssetAtPath<Texture>(value));
            }
        }
    ...
    [UxmlElement]
    public partial class ListItemSearchBar : ListItem{
    ...
    [UxmlElement]
    public partial class EntityViewer : NodeViewer<Entity>{
        ...
        protected UnityEngine.Vector2 lastNodePosition;
        protected UnityEngine.Vector2 boxSelectionStartingPosition;
        ...
        public EntityViewer() : base(){
            ...
            this.boxSelectionStartingPosition = new UnityEngine.Vector2();
        }
        ...
        protected override void InitializeElement(){
            ...
            anchor.style.scale = new StyleScale(new Scale((UnityEngine.Vector3)new(1,1,1)));
            ...
            this.RegisterCallback<MouseUpEvent>(e =>{
                ...
                if(e.button == 1){
                    if(e.target == this && !hasDraggedAnchor){
                        AnchorItemPositionFromMouse(e, out UnityEngine.Vector2 position);
                        lastNodePosition = position;
                        UnityEngine.Vector2 positionOffset = e.mousePosition - new UnityEngine.Vector2(75,65);
                ...
                foreach(Entity entity in entities){
                    if(!nodeCache.ContainsKey(entity)){
                        ...
                        newNode.RegisterCallback<MouseUpEvent>(e =>{
                            ...
                            lastNodePosition = new UnityEngine.Vector2(rect.x, rect.y);
                            ...
                            if(e.button == 1){
                               //select first
                                ...
                                UnityEngine.Vector2 position = e.mousePosition - new UnityEngine.Vector2(75,65);
                ...
                for(int i = 0; i < otherNodes.Length; i++){
                    if(node != otherNodes[i]){
                        ...
                        if(nodeRect.Overlaps(otherNodes[i].AbsoluteRect())){
                            ...
                            node.lastRestingPosition = new UnityEngine.Vector2(nodeRect.x,nodeRect.y);
                            i = 0;
                        }
                    }
                }
        ...
        protected void DragNodes(MouseMoveEvent e){
            UnityEngine.Vector2 offsetPosition = (e.mousePosition * (1/anchor.style.scale.value.value.x)) - lastMousePosition;
            if(offsetPosition.magnitude > 5) hasDraggedNodes = true;
            foreach(Node<Entity> node in draggingNodes){
                UnityEngine.Vector2 offset = node.lastRestingPosition + offsetPosition;
                node.style.left = offset.x;
                node.style.top = offset.y;
            }
        }

        protected void StopDraggingNodes(UnityEngine.Vector2 mousePosition){
        ...
        protected void BoxSelectionStep(MouseMoveEvent e){
            UnityEngine.Vector2 size = boxSelectionStartingPosition - e.localMousePosition;
        ...
        protected void BoxSelect(MouseUpEvent e){
            if(CanBoxSelect()){
                UnityEngine.Vector2 anchorPosition = anchor.PositionToVector2(); 
        ...
        protected void ArrangeByWorldSpace(){
            ...
            UnityEngine.Vector2 furthestOut = selectedNodes.First().PositionToVector2();
            ...
            foreach(Node<Entity> node in selectedNodes){
                if(world.GetComponent<UnityGameObject>(node.key)?.component.gameObject is GameObject go && go != null){
                    UnityEngine.Vector3 pos = go.transform.position.Snap();
                ...
                UnityEngine.Vector2 position = node.PositionToVector2();
                        ...
                        if(positions[y].ContainsKey(z)){
                            ...
                            for(int x = minX; x <= maxX; x++){   
                                if(positions[y][z].ContainsKey(x)){
                                    ...
                                    UnityEngine.Vector2 newPosition = new(){
